...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "DSI"};
	private String[] yearString = new String[] {"1","2","3"};
	private String[] subject1tring = new String[] {"SYSTEM LOGIQUE","LANGAGE C"};
	private String[] subject2tring = new String[] {"ANGULAR","SYMFONY"};
	private String[] subject3tring = new String[] {"DEV MOBILE","SOA"};

	private String[] subjectFinal = new String[] {"SYSTEM LOGIQUE","LANGAGE C","ANGULAR","SYMFONY","DEV MOBILE","SOA"};
